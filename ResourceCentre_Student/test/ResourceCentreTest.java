...
public class ResourceCentreTest {
	...
	public void testAddChromebook() {
		...
		assertEquals("Test that Chromebook arraylist is empty.", 0, chromebookList.size());
		...
		ResourceCentre.addChromebook(chromebookList, cb2);
		assertEquals("Test that the Camcorder arraylist size is unchanged.", 2, chromebookList.size());
	...
	public void testRetrieveAllChromebook() {
		ArrayList<Chromebook> chromebookList = new ArrayList<>(); // Initialize the chromebookList
		...
		// Test Case 2
		Chromebook cb1 = new Chromebook("CB0011", "My Google Chromebook 1st", "Mac OS");
		Chromebook cb2 = new Chromebook("CB0012", "SAMSUNG Chromebook 4+", "Win 10");
		...
		// Test Case 3
		Chromebook cb3 = new Chromebook("CB0013", "Acer Chromebook 15", "Chrome OS");
